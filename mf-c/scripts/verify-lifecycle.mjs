...
// for MF-C. Loads the SystemJS bundle served on http://localhost:4203/main.js
...
const APP_NAME = '@mf/mf-c';
const BUNDLE_URL = 'http://localhost:4203/main.js';
